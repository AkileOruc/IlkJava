...
public class C04_ForLoopGeriGeriYazd {
...
// eger sart i'nin hicbir degeri icin true olmuyorsa
        ...
        if (input>1){
            for (int i = input; i >= 1 ; i--) {  //pozitif deger icin,o degerden basla 1e kadar ,geri geri 1erli yaz
                System.out.print(i + " ");
            }
        }else{
            for (int i = input; i <=1 ; i++) {
                System.out.print(i + " ");   //eksi bir deger icin o degerden basla 1 e kadar artirarak yaz
            }
        }
