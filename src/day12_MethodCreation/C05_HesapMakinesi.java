...
import java.util.Scanner;
    ...
    public class C05_HesapMakinesi {
        public static void main(String[] args) {
            ...
            // sonucu bize dondurun.                                   //yani void degil
            ...
            char islem=scan.next().charAt(0);                              //buraya kadar her sey eskisi gibi yapildi
            System.out.println(hesapMakinasi(sayi1, sayi2, islem));       // method calling yaptik :)
        }
