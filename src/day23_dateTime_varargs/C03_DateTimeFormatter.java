...
public class C03_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println(ldt);       //2022-12-20T10:46:18.052008700

// sadece tarihi  20/12/2022  seklinde yazdirmak icin bir format olusturalim

        DateTimeFormatter format1 = DateTimeFormatter.ofPattern("dd/MM/YYYY");
        System.out.println(ldt.format(format1));

        //Sadece tarihi 12.20.22 Sal seklinde

        DateTimeFormatter format2 =DateTimeFormatter.ofPattern("MM.dd.yy EEE");
        System.out.println(ldt.format(format2));

        //Sadece zaman 10:49 am olarak yazdirin
        DateTimeFormatter format3 = DateTimeFormatter.ofPattern("hh:mm a");
        System.out.println(ldt.format(format3));     // 11:07 O O  ogleden once
