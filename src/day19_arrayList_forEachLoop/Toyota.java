...
public class Toyota {
    ...
    int km;
    String renk;
    // default constructor suna benzer methoda benzer ama method degildir
    public  Toyota(){                   //bunu yazinca default constructor kendi kendine silindi
        System.out.println("Toyota class'indaki cons. calisti"); // bu parametresiz constructor
    }
    /*
