...
public class C05_WrapperClass {
    public static void main(String[] args) {
        ...
        char krk1='$';
        System.out.println(Character.isDigit(krk1)); // false     // bu bir sayi mi
        System.out.println(Character.isLetter(krk1)); // false    //  bu bir harf mi
        System.out.println(Character.isAlphabetic(krk1)); // false

        Short sayi6=45;
        // Integer sayi 7= (Integer) sayi6;     // calismaz
